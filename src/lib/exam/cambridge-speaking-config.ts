...
const YLE_PART_DEFS: Record<1 | 2, CambridgePartDef> = {
  1: {
    ...
    speakingSeconds: 45,
    practiceTimeLimitSeconds: 4 * 45 + 60,
  ...
  2: {
    ...
    speakingSeconds: 60,
    practiceTimeLimitSeconds: 3 * (15 + 60),
...
const STANDARD_PART_DEFS: Record<CambridgeSpeakingPart, CambridgePartDef> = {
  1: {
    ...
    speakingSeconds: 45,
    practiceTimeLimitSeconds: 5 * 45 + 60,
  ...
  2: {
    ...
    speakingSeconds: 90,
    practiceTimeLimitSeconds: 4 * (30 + 90),
  ...
  3: {
    ...
    preparationSeconds: 0,
    speakingSeconds: 60,
    practiceTimeLimitSeconds: 4 * 60 + 60,
