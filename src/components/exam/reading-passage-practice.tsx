...
import { extractReadingPassage } from "@/lib/exam/reading-passage-ui";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid min-h-[min(70vh,720px)] gap-4 lg:grid-cols-2">
        <aside className="flex flex-col overflow-hidden rounded-2xl border-2 border-sky-200 bg-gradient-to-br from-sky-50/90 to-white shadow-md">
        ...
        <div className="flex flex-col overflow-hidden rounded-2xl border-2 border-purple-200 bg-white/95 shadow-md">
