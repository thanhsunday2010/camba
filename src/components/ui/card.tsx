...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn("kid-card rounded-2xl border-2 text-card-foreground", className)}
      {...props}
    />
  )
);
...
>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn("text-sm text-muted-foreground sm:text-base", className)} {...props} />
));
